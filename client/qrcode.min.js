/**
 * Pure JavaScript QR Code generator (Standalone, zero dependencies)
 * Optimized for dynamic UPI Payment links & invoice encoding.
 */
(function(window) {
  // Simple, robust QR Code generator implementation
  ...
  QRCodeModel.prototype = {
    ...
    make: function() {
      // Auto-detect typeNumber if small
      if (this.typeNumber < 1) {
        ...
        for (typeNumber = 1; typeNumber < 10; typeNumber++) {
          ...
          var totalLength = 0;
          for (var i = 0; i < this.dataList.length; i++) totalLength += this.dataList[i].getLength();
  ...
  // High-level wrapper function to render on Canvas or Image
  window.QRCode = function(target, options) {
    ...
    var qr = new QRCodeModel(4, 1); // Type 4, Level M
    qr.addData(text);
    qr.make();
    ...
    var tileW = width / count;
    var tileH = height / count;
    ...
    for (var r = 0; r < count; r++) {
      for (var c = 0; c < count; c++) {
        ctx.fillStyle = qr.isDark(r, c) ? colorDark : colorLight;
